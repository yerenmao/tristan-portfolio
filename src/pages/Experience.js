...
const Details = ({ experience='', ranking='', time='' }) => {
  ...
  return (
    <motion.li className='flex
      my-8 mx-auto first:mt-0 w-[95%] sm:w-[80%] md:w-[60%]'
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className='flex flex-col items-start justify-between'>
        <div ref={liRef} className='flex flex-col'>
          <h3 className='font-bold text-xl lg:text-2xl text-lightt/90 dark:text-darkt/90 pb-4'>
            {experience}
          </h3>
...
const Experience = () => {
  ...
  return ( 
    <>
      <h2 className='font-bold text-2xl sm:text-4xl md:text-6xl w-full text-center my-8 md:my-16 md:mb-20 text-lightt dark:text-darkt'>
        Experience
      </h2>
      <div ref={ref} className='w-full sm:w-[90%] md:w-[80%] relative mb-96 mx-0 md:mr-10 md:mx-auto'>
        <motion.div 
        ...
        '/>
          <ul className='w-full flex flex-col items-start justify-between ml-2 sm:xl-4'>
            ...
            />
            <Details 
              experience='2023 FUN AI WINTER CAMP 競賽'
              ranking='進階組 第二名'
